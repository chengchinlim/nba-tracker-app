...
app.post('/player', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var player, created;
...
app.get('/player', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, player_1.Player.findOne({
                    teamId: 1
                })];
            case 1:
                players = _a.sent();
...
//   }
// })
app.post('/stats', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var season, team, statsPerGames, filePaths, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, main_3.writeDataToLocalStorage)({
                        externalFilePath: "seasons/".concat(season, "/teams/").concat(team, ".json"),
                        response: statsPerGames
                    })];
            case 2:
                filePaths = _a.sent();
                return [4 /*yield*/, (0, main_4.writeToS3Bucket)(filePaths)];
            case 3:
                _a.sent();
